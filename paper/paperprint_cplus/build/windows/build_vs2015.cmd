...
SET CD_DIR=%CD%
@IF EXIST vs2015 rmdir /s /q vs2015
mkdir vs2015
CD vs2015
...
cmake %CD_DIR%/../ -G "Visual Studio 14 2015" -A x64
rem cmake --build %CD_DIR%\vs2015 --target ALL_BUILD --config Release 
cmake --build %CD_DIR%\vs2015 --target ALL_BUILD --config Release
