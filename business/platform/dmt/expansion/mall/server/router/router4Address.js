 ...
 */
class router4Address extends router4Module {
  ...
  loadAPIMethods() {
    ...
    this.router.use(function timeLog(req, res, next) {
      ...
      console.log(time + ",acess address module,version=" + JSON.stringify(req.params));
    ...
    this.router
      ...
      .post(function (req, res, next) {
        myController.addresslist(req).then(result => {
          RouterUtil.copyDataAndNext(res, result, next)
        });
      });
  }
}
export default router4Address;