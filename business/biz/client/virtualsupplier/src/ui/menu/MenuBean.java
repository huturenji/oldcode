...
public class MenuBean {
    ...
    private ArrayList<MenuBean> children;

    public MenuBean(String key, String title, ArrayList<MenuBean> children) {
        super();
        this.key = key;
        this.title = title;
    ...
    public void setChildren(ArrayList<MenuBean> children) {
        this.children = children;
    }

    @Override
    public String toString() {
        return "menu [title=" + title + ", children=" + children + "]";
    }
