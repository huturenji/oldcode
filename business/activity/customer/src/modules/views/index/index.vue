...
import iconshouye from "assets/icon_nav_shouye_nor.png";
...
import iconsitename from "assets/img_nav_cjhdht_name.png";
export default {
  extends: menuhome,
  data() {
    return {
      userDropDownList: ["修改密码"], //右上角的下拉菜单项
      breadcrumbFirst: [], //面包屑的第一个节点。默认配置的是 运营平台，这里配置空
      path_modifypwd: "/sysmgr/userpwd-update",
      // path_serviceAgreement: "/sysmgr/userpwd-forgot",
      iconhttp:
      ...
      nomenutop: true, //不显示menu的title
      sitename: iconsitename,
    };
  },
  created() {
    // this.sitename = "抽奖活动后台";
    this.menuTitle = "客户端";
    this.pageRootPath = "/";
  ...
  methods: {
    ...
    initMenuList() {
      //获取本地配置的所有的菜单组件
      this.homeMenuList = this.getMyAllMenus();
    },
    /**
     * 右上角的菜单下拉被点击的事件
     */
