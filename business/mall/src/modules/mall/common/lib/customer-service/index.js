...
import getUserInfor from './userInfor';

const ZC_URL = 'https://chaten.sobot.com/chat/h5/v2/index.html?sysnum=dcce9016106c4275adca76544d320c18'; //客服对接应用的url
    ...
    run(mode=1, config, type){
        ...
        return new Promise((res, rej) => {
            getUserInfor().then(data=>{
                ...
                if(mode == 1){ //链接对接方式
                    res(this.getWholeZcUrl(zcConfig));
