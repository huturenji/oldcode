...
export default {
    ...
    filters:{
        dateFormat: function (value) {
            try{
                ...
                let dateStr = startDate.format("MM月dd日".replace(/\-/g, '/'));
    ...
    methods: {
        ...
        // 关闭弹窗
        closePopup(){
            this.$emit('closeCalendarInstallDatePopup');
        },
...
@import '~themes/default/styles/order/confirm/calendarInstallDate.less';
</style>