<template>
    <div ref="activity" :class="{noscroll:noscroll}">
        <div ref='outPageWrap' class="activityOutWrap" @scroll="outPageWrapScroll">
            <div class="activityWrap">
                ...
                <div class="activityTime">
                    <span class="countdownText">{{countdownText}}</span>
                </div>
                ...
                <div class="tabWrap" ref="tabWrap">
                    <tab ref='tabBox' :line-width=3 active-color='#FF8730' default-color="#333333" custom-bar-width='.4rem' bar-active-color="#FF8730">
                        <tab-item  
                        class='tab-item' 
                        ...
                        <div class="goodsShowWrap" :style="leftStyle">
                            <div class="goods" v-for="(group, index) in activityGoodsDate" :key="index">
                                ...
                                <div class="goodsItem" v-else @click="gotoGoodsDetails(item, ind)" v-for="(item, ind) in group.goodsList" :key="ind">
                                    ...
                                    :title='item.name'
                                    :price='before?employeePriceDate[item.sku]:item.unitPrice'
        ...
        <!-- 右下加跳转购物车的模块  -->
        <cartThumb class="activityCartThumb" ref='cartThumb' v-if="!isguest" @clickCartThumb="clickCartThumb"></cartThumb>
    ...
    export default {
        ...
        data() {
            ...
            return Object.assign(extendUtils.stateManager.setData([
                ...
                markingPriceDateData:markingPriceDate,//划线价
                employeePriceDate:employeePrice,//活动未开始时的员工价
                ...
                startTime:new Date("2021/06/22 12:00:00").getTime(),//活动开始时间
                endTime:new Date("2021/06/22 20:00:00").getTime(),//活动结束时间
                // nowTime:new Data().getTime()
                countdownText:'',
        ...
        async created() {
            ...
            if(nowTime<this.startTime){
                extendUtils.showToast('活动还没开始呢，可以先加入购物车哦',null,3000);
            }
        ...
        computed:{
            ...
            listHeight(){
                if(this.activityGoodsDate[this.activeIndex].goodsList.length==0){
                    ...
                    let itemHeight = this.isPC?390:5.38;
        ...
        setThirdShare(){
            ...
            callBackUrl = callBackUrl.replace('&pageFrom=index','');//去除pageFrom标记
            let shareInfo = {
                title:'员工限时特惠', // 分享标题 
            ...
            activityCountdown(){
                ...
                if(nowTime<this.startTime){
                    ...
                    this.before=false
                    this.end=true
                    this.countdownText = '活动已结束：00小时00分00秒'
                    extendUtils.showToast('活动已结束，下次记得早点来哦');
                }
            },
...
@import '~themes/default/styles/activity/activitys.less';
</style>
