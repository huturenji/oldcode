	        ...
	        return (
	            <SubMenu
	                title={
	                    item.icon ? (
	                        <span>
	                            {specialFlag > -3&&(item.path == '/marketing_svideo'||item.path == '/marketing_live'||item.path == '/marketing_spreader')
	                                ?<img src={require('@/assets/img/common/must_add.png')} style={{marginLeft:0,width:32,height:16,marginTop:-5,marginRight:3}} />
	                                :getIcon(item.icon)
	                            }
