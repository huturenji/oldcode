...
export default [
    ...
    },
    {
        ...
        defaultvalue: {
            ...
            searchBorderRadiu:'0',
            showBtn:false,//是否展示搜索按钮
            btnBackground:'#f30300',
            btnBorderRadiu:'8',
            btnSearchText:'手机',
            showBtnSearch:false,
            leftData:[{
                    ...
                    true: [
                        {
                            guid: guid(),
                            name: 'sn-radio',
                            label: "是否启动暗文搜索（点击是否跳转商品列表页）",
                            type: 'radio',
                            options: [{ key: true, value: '是' }, { key: false, value: '否' }],
                            valuekey: ['showBtnSearch']
                        },
                        {
                            guid: guid(),
                            name: 'sn-text',
                            type: 'input',
                            label: '搜索关键字（跳转商品列表页后搜索出来的商品类型）',
                            style: {
                                'marginBottom': '10px'
                            },
                            valuekey: ['btnSearchText']
                        },
                        {
                            guid: guid(),
                            name: 'sn-text',
