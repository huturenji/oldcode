            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text, record) => <Switch
                        disabled={!hasAuth('switch_expiry')}
                        checkedChildren={`${sldComLanguage('开启')}`}//开启
                ...
                },
                {
                    ...
                    render: (text, record) => (
                        <Fragment>
                            ...
                            <AuthBtn eventKey={['edit_expiry']} btnAuth={btnAuth}>
                                {sldtbaleOpeBtnText(`${sldComLanguage('编辑')}`, () => this.edit(record))}
                            </AuthBtn>
                            <AuthBtn eventKey={['set_bill_date_expiry']} btnAuth={btnAuth}>
                                <span className={global.splitLine} />
                                {sldtbaleOpeBtnText(`${sldComLanguage('设置结算周期')}`, () => this.setBillCycle(record))}
                            </AuthBtn>
                            <AuthBtn eventKey={['delete_expiry']} btnAuth={btnAuth}>
                                {record.state == 2 &&
                                    <Fragment>
                                        <span className={global.splitLine} />
