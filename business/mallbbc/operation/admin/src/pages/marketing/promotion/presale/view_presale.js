                          ...
                          >
                              ...
                              {query.type == 1
                                  ?<div className={`${global.flex_row_start_center} ${promotion.add_new}`} style={{marginTop:10}}>
                                      ...
                                      <span style={{ color: 'gray', fontSize: '12px', paddingLeft: '10px' }}>温馨提示：若因商家问题导致无法发货，需要对会员进行赔偿，赔偿金额为定金的{compensateRate}倍。</span>
                                  </div>
