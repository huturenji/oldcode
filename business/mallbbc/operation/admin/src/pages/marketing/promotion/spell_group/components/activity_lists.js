...
export default class ActivityLists extends Component {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text, record) => (
                        <Fragment>
                            <Link to={{
                                pathname: '/marketing_promotion/spell_group_to_view',
                                query: {
                                    id: record.spellId,
                                    tar:'view'
                                }
                            ...
                            <Fragment>
                                <Link to={{
                                    pathname: '/marketing_promotion/spell_group_bind_goods',
                                    query: {
                                        id: record.spellId
                                    }
                                }}
              ...
              <Fragment>
                  <Link to={{
                      pathname: '/marketing_promotion/spell_group_order',
                      query: {
                          id: record.spellId
                      }
                  }}
  ...
  get_list = (params) => {
      ...
      dispatch({
          type: 'spell_group/get_all_spell_group_list',
          payload: { ...params },
          callback: (res) => {
  ...
  operate = (id, type) => {
      ...
      let dis_type = '';
      if (type == 'invalid') {
          dis_type = 'spell_group/invalid_spell_group';
          param_data.spellId = id;
      } else if (type == 'del') {
          dis_type = 'spell_group/del_spell_group';
          param_data.spellId = id;
      }
