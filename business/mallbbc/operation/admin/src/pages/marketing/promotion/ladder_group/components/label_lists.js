...
export default class LabelLists extends Component {
        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text, record) => (
                        <Switch
                            onChange={(checked) => this.operateLabel({ labelId: record.labelId, isShow: checked ? 1 : 0 }, 'switch')}
  ...
  operateLabel = (id, type) => {
      ...
      let param_data = {};
      if (type == 'del') {
          dis_type = 'ladder_group/del_label';
          param_data = { labelId: id };
      } else if (type == 'edit') {
          dis_type = 'ladder_group/edit_label';
          param_data = id;
      } else if (type == 'switch') {
          dis_type = 'ladder_group/switch_label';
          param_data = id;
      }
      dispatch({
          type: dis_type,
  ...
  get_list = (params) => {
      ...
      const { dispatch } = this.props;
      dispatch({
          type: 'ladder_group/get_label_lists',
          payload: params,
          callback: (res) => {
