...
import {
    sld_systemset_authority_import2
...
@Form.create()
export default class SellerImport extends Component {
    constructor(props) {
        super(props);
        this.state = {
            initLoading: false,
    ...
    addObjToReq = (reqData, bisObj, grade) => {
        let reqArr = reqData.resourcesList || reqData.children
        //grade == 1了 递归结束，开始赋值
        if (grade == 1) {
            // 父节点id
    ...
    initAuth = (params) => {
        ...
        dispatch({
            type: 'authority/init_all_permission_seller',
            payload: params,
            callback: (res) => {
    ...
    render() {
        ...
        return (
            <div className={global.common_page} style={{ flex: 1 }}>
                ...
                {showMoreHelpTip("", sld_systemset_authority_import2(), 0, true, true)}
