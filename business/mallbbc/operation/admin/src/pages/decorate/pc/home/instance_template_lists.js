...
export default class Instance_template_lists extends Component {
	        ...
	        columns: [
	            ...
	            },
	            {
	                ...
	                render: (text, record) => <Switch
	                    disabled={!hasAuth('switch_pcdeco_instance_tpl')}
	            ...
	            },
	            {
	                ...
	                render: (text, record) => (
	                    <Fragment>
	                        <AuthBtn eventKey={['edit_pcdeco_instance_tpl']} btnAuth={btnAuth}>
	                        {sldtbaleOpeBtnText(`${sldComLanguage('编辑')}`, () => this.diyTpl(record))}{/*装修*/}
	                        <span className={global.splitLine} />
	                        </AuthBtn>
	                        {/*删除后不可恢复，是否确定删除？*/}
	                        <AuthBtn eventKey={['delete_pcdeco_instance_tpl']} btnAuth={btnAuth}>
	                        ...
	                        <AuthBtn eventKey={['copy_pcdeco_instance_tpl']} btnAuth={btnAuth}>
  ...
  resize = () =>{
	...
	diyTpl = (val) => {
	    //装修数据存缓存
	    val.back_route = '/decorate_pc/instance_template_lists';
	    setStorage('pc_diy_tpl', JSON.stringify(val));
	    router.push('/decorate_pc/instance_template_lists_to_add');
	};
	...
	render() {
	    ...
	    return (
	        <div className={global.common_page}>
	            ...
	            <AuthBtn eventKey={['view_pcdeco_instance_tpl']} btnAuth={btnAuth} showPage>
	            ...
	            <Spin spinning={loading}>
	                ...
	                <div className={global.operate_bg}>
	                        <AuthBtn eventKey={['add_pcdeco_instance_tpl']} btnAuth={btnAuth}>
