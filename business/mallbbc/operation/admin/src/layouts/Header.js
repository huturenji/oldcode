...
import {
    failTip ,
    sucTip , loginOut, getStorage, getLocalStorageJsonVal, getLocalStorageStingVal
} from '@/utils/utils';
...
class HeaderView extends PureComponent {
  ...
  sldHandleConfirm = (val) => {
      ...
      //需要加上用户id uuid user_id
      let source= getLocalStorageStingVal('sld_token').split('.')[1]
      val.adminId = JSON.parse(Buffer.from(source,'base64')).user_id      
      dispatch({
