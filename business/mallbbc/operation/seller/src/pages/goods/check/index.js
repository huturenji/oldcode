...
export default class GoodsCheckLists extends Component {
              ...
              },
              {
                  ...
                  render: (text, record) => (
                      <Fragment>
                          ...
                          >
                              <AuthBtn btnAuth={btnAuth} eventKey={["goods_check_list_edit"]}>
  ...
  get_list = (params) => {
      ...
      dispatch({
          ...
          payload: { ...params, state: 2 ,pageIndex:params.current||1,storeId},
          callback: (res) => {
  ...
  render() {
      ...
      return (
          <div className={global.common_page} style={{ flex: 1}}>
              <AuthBtn eventKey={[`goods_check_list_view`]} btnAuth={btnAuth} showPage>
