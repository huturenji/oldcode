...
export default class DiyLists extends Component {
            ...
            columns: [
                    ...
                    render: (text, record) => (
                        <Fragment>
                            <div className={global.flex_com_space_between}>
                                ...
                                {record.is_edit_name != undefined && record.is_edit_name
                                    ? <AuthBtn btnAuth={btnAuth} eventKey={["descorate_edit"]}><a
                                    ...
                                    : <AuthBtn btnAuth={btnAuth} eventKey={["deco rate_edit"]}><a
                                        className={global.flex_com_column}
                                        href="javascript:void(0)"
                                        style={{ marginLeft: 7 }}
                ...
                },
                {
                    ...
                    render: (text, record) => <Switch
                        disabled={!hasAuth('decorate_edit')}
                ...
                },
                {
                    ...
                    render: (text, record) => (
                        ...
                        !hasAuth('decorate_edit') ? '--' :
                            <Fragment>
                                <AuthBtn btnAuth={btnAuth} eventKey={["decorate_edit"]}>
                                    <Link
                                        to={{ pathname: `/store/decorate_pc_home_to_edit`, search: `?id=${record.decoId}` }}
                                        target="_blank"
                                    >
                                        {
  ...
  render() {
      ...
      return (
          <AuthBtn btnAuth={btnAuth} eventKey={["decorate_view"]} showPage>
              <div className={global.common_page} style={{ padding: 0 }}>
                  <Spin spinning={loading}>
                      ...
                      {/*公共功能条-start*/}
                      <AuthBtn btnAuth={btnAuth} eventKey={["decorate_add"]}>
