                              ...
                              <div className={`${styles.floor_con} ${styles.floor_con3}`}>
                                  <div className={styles.floor_title}>
                                      ...
                                      <h2>
                                          ...
                                          >{data.title_info.title.initialValue != '' ? data.title_info.title.initialValue : `${sldComLanguage('添加标题')}`}</span>
                                          <span
                                              className={styles.sub_title}
                                          >{data.title_info.sub_title.initialValue != '' ? data.title_info.sub_title.initialValue : `${sldComLanguage('添加子标题')}`}</span>
                                      </h2>
                                      ...
                                      >
                                          ...
                                          <div className={styles.floor_right_new}>
                                              <div className={styles.floor_right_new_top_title}>
                                                  ...
                                                  >{data.right.title_info.title_name != '' ? data.right.title_info.title_name : `${sldComLanguage('添加标题')}`}</span>
                                                  <font
                                                      style={{ background: data.right.title_info.title_color ? data.right.title_info.title_color : '#fc5863' }}
                                                  />
                                              </div>
