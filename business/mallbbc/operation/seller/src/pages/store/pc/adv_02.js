          ...
          <Fragment>
              ...
              <img src={data.left.data.imgUrl} />
                      ...
                      <div className={styles.adv_02_center}>
                          <span className={styles.split_h} />
                          <span className={styles.split_v} />
                          {data.center.data.goods_ids.length > 0 &&
              data.center.data.goods_data.map((item, index) => <div key={index} className={`${styles.goods_item} ${styles.clearfix}`}>
                  ...
                  <div className={styles.right}>
                      ...
                      <p
                          className={styles.buy_num}
                      >{item.actualSales + item.virtualSales}人已买</p>
                      <div className={styles.price}>
                          <span className={styles.unit}>¥</span>
                          <span className={styles.integer}>{item.goodsPrice}</span>
                          {item.marketPrice * 1 > 0 &&
                      <span className={`${styles.btn_common} ${styles.del}`}>¥{item.marketPrice}</span>}
                      </div>
                      ...
                      <div className={styles.adv_02_right}>
                          {data.right.data.map((item, index) => <span key={index} className={styles.right_img_item}>
                              <img src={item.imgUrl} />
                          </span>)}
                          <div
                              className={styles.sld_mask}
