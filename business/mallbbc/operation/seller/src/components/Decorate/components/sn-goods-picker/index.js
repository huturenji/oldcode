...
export default class SnGoodsPicker extends Component {
    ...
    render() {
        ...
        let {modalVisibleGoods,modalVisibleLive,modalVisibleVideo,showMoreGoods,goodsText,data} = this.state
        return (     
            <div style={style}>
                ...
                <div className={`${styles.selected_svideo} ${global.flex_column_start_start}`}>
                    ...
                    {value?.info&&value.info.length > 0 &&
                        <div>
                                                        ...
                                                        >
                                                            {type == 'goods'&&<div>
                                                                {svideo_index<5&&<div className={`${styles.selected_svideo_item} ${global.flex_row_start_center}`}>
                                                                    ...
                                                                    <div
                                                                        onClick={() => this.delItem(svideo_item.sku)}
