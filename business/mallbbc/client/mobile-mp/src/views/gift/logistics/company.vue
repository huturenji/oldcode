        ...
        <view class="logistics_company_search">
            <view class="compnay_search">
                <view class="logistics_company_left">
                    ...
                    <input type="text" :value="inputVal" placeholder="请输入物流公司)" @input="getValue" @blur="goSearch" />
                </view>
                <image src="https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/common/icon/close.svg" mode="" class="close_btn" v-if="inputVal!=''" @click="clearVal"></image>
            </view>
            <view class="go_search" @click="goSearch">搜索</view>
        </view>
        <!-- 搜索 end -->
        <!-- 物流公司列表 start -->
...
import { expressList } from "@/views/components/aftersale/handler";
