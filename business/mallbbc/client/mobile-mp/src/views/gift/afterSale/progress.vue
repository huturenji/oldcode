        ...
        <view class="progress_content">
            <view class="progress_content_item" v-for="(item,index1) in returnLogList" :key="index1">
                ...
                <view class="circle_icon_wrap">
                    <view class="circle_icon_box">
                        <image src="https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/common/icon/icon_setp_sel3_red.svg" mode="" class="circle_active"
                        v-if="index1 == 0"></image>
...
<script>
import { detail, replacementDetail } from "@/views/components/aftersale/handler";

export default {
    data() {
        return {
            to_right: 'https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/common/icon/btn_common_rightarrow_gray.svg',
            afsSn: '', // 售后单号
            state: '', // 退换货状态
            returnLogList: [],
    ...
    methods: {
        ...
        loadData() {
            ...
            let func = this.state == 2 ? replacementDetail : detail;
