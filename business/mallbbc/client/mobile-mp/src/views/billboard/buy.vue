...
<template>
    <view ref="container" class="container"  @click="hideFilterList()" @longpress="hideFilterList()" @touchmove="hideFilterList()"> 
        <u-navbar title="都在买" :bgColor="bgColor" autoBack :titleStyle="{ color: '#222', 'font-weight': 'bold' }">
        </u-navbar>
        ...
        <view class="goods_list_buy flex_column_start_start" v-if="isLoaded">
            ...
            <view v-if="!immersive" class="flex_column_center_center empty_part">
                <view class="flex_column_start_center empty_content">
                    ...
                    <text class="tip_con">未有朋友购买过商品</text>
        ...
        :state='loadingState' loadingImg='icon_common_wprocess.png' 
...
<script>
import thumbBillboard from "@/views/components/thumb/thumb-billboard.vue";
...
export default {
    ...
    methods: {
        ...
        judgeHasMore() {
            ...
            this.hasMore = checkPaginationHasMore({current:this.localCurrent,pageSize:10,total:this.initSkuList.length}); //是否还有数据
            if (this.hasMore) {
                this.localCurrent++;
...
<style lang='scss' scoped>
    ...
    .empty_part {
        ...
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/billboard/bg_dzm_kapian.svg') top no-repeat;
        background-size: 100% auto;
        .empty_content{
    ...
    .goods_list_buy {
        ...
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/billboard/bg_dzm_bg.png') no-repeat top;
        background-size: 100% auto;
        position: relative;
        &>view:nth-of-type(3){
            .zhuzi_1{
        ...
        .renwubg{
            width:328rpx;
            height: 296rpx;
            background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/billboard/bg_dzm_ren.png') no-repeat;
            background-size: 100% auto;
            position: absolute;
            top: 240rpx;
            left: 104rpx;
        ...
        .billboardWrap{
            ...
            .zhuzi_1{
                width: 22rpx;
                height: 20rpx;
                background: url(https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/billboard/icon_dzm_yuanzhu.svg) no-repeat;
                position: absolute;
                left: 134rpx;
                top: 0rpx;
            }
    ...
    .floatBut{
        ...
        width: 112rpx;
        height: 112rpx;
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/billboard/more_goods.png');
        background-size: 100%;
        border-radius: 50%;
        transition: all 0.3s;
        user-select: none;
    ...
    .filterBox{
        ...
        .filterText{
            ...
            .sanjiao{
                ...
                margin-left: 8rpx;
                &.down{
                   background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/common/icon/xiala_down.png') center no-repeat;
                   background-size: 100% 100%;
                }
                &.up{
                   background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/common/icon/xiala_up.png') center no-repeat;
                   background-size: 100% 100%;
                }
            }
        }
