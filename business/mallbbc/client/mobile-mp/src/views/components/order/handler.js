...
export default {
    ...
    */
     ...
     * @param {*} param 
    */
    confirm1(param, config){
        return request({
            ...config,
            url: '/v3/business/front/orderOperate/confirm1',
            method: 'POST',
            header:{"Content-Type": "application/json"},
            data: param
        })
     ...
     * @param {*} param 
    */
    balanceConfirm(param){
        return request({
            url: '/v3/business/front/orderOperate/balanceConfirm',
            method: 'POST',
            header:{"Content-Type": "application/json"},
            data: param
        })
    ...
    */
    balanceSubmit(param){
        return request({
            url: '/v3/business/front/orderOperate/balanceSubmit',
            method: 'POST',
            header:{"Content-Type": "application/json"},
            data: param
        })
    ...
    */
    getPayInfoApi(param){
        return request({
            url: '/v3/business/front/orderPay/payInfo',
            method: 'GET',
            header:{"Content-Type": "application/json"},
            data: param
        })
