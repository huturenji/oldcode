<template>
    <view class="search_panel_wrapper">
        ...
        <view v-else class="cancel_btn" @click="cancelKeywordSearch"> 取 消 </view>
        </view>
        ...
        <view class="time_panel">
            ...
            <sortItem :data="filterSortData" @select="selectChange"> </sortItem>

            <view class="btn_wrapper">
            <view class="content_wrapper">
                <view :class="['btn', 'reset_btn', disabledBtn ? 'btn_opacity' : '']" @click="resetSelected">重置</view>
                <view :class="['btn', 'confirm_btn', disabledBtn ? 'btn_opacity' : '']" @click="searchOrder">确定</view>
            </view>
            </view>
        </view>
        </bottomPopup>
...
export default {
    ...
    computed: {
        disabledBtn() {
            return this.seletedItems.length === 0;
        },
    },
    methods: {
        // 筛选面板开启
...
.search_panel_wrapper {
    ...
    .top_search {
        ...
        .filter_btn {
            ...
            height: 40rpx;
            margin-left: 28rpx;
            background-image: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/order/btn_hx_sc_wode.svg');
