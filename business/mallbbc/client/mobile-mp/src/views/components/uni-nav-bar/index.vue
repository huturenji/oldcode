	...
	<view class="uni-navbar">
		<view
			:class="{
				...
				'uni-navbar--shadow': false,
				'uni-navbar--border': false,
			}"
		...
		>
			...
			>
				...
				>
					...
					>
						<text class="uni-nav-bar-right-text">333{{
							rightText
						}}333</text>
					</view>
					<slot name="right" />
...
<script>
import uniStatusBar from "@/views/components/uni-status-bar";
import uniIcons from "@/views/components/uni-icons/uni-icons";
