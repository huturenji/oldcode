            ...
            <view class='redpacket-content'>
                ...
                <view class="redpacket_pre_right">
                    <view class="haveNotUse" v-if="redpacketInfo.publishValue">
                        <view>
                            {{redpacketState ? '已领取' : '已失效'}}
                        </view>
                        <view @click="toUse" v-if="redpacketState">去使用</view>
                    </view>
                </view>
            </view>
        </view>
...
<script>
import redpacketHandler from '@/views/components/redpacket/handler';
...
.container{
    ...
    .my_redpacket_pre {
        ...
        .redpacket-content {
            width: 100%;
            height: 190rpx;
            background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/decorate/redpacket/bg_wode_hongbao.png') no-repeat;
