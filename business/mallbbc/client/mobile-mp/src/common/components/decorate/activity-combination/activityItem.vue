            ...
            <view class="goodsWrap" :style="[setTopStyle(decoData)]">
                <view  v-for="(item, index) in 2" :key='index' class="itemWrap">
                    <view class="no-goods-img">
                        <image class="image" src="https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/decorate/picture%402x.png"/>
                    </view>
...
.timeLeft{
    background-image: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/decorate/naozhong%402x.png');
...
.timeRight{
    ...
    align-items: center;
    .time{
        background-image: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/decorate/bg_bnj_time1.png');
        background-position: center center;
        background-repeat: no-repeat;
        background-size: cover;
        text-align: center;
    ...
    .time_tips{
        background-image: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/decorate/bg_bnj_time2.png');
        background-position: center center;
        background-repeat: no-repeat;
        background-size: cover;
        text-align: center;
