    ...
    <view :style="[styles]">
        <view class="activityWrap">
            ...
            <view v-if="decoItem.props.show_style ==='two'" class="styleTwoWrap">
                <view class="leftWrap">
                    <image :src="decoItem.data[0].areaTwo.img" @click="goDetail(decoItem.data[0].areaTwo.link)"/>
                    <image :src="decoItem.data[0].areaThree.img" @click="goDetail(decoItem.data[0].areaThree.link)"/>
                </view>
