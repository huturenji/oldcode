 ...
 * @LastEditTime: 2023-04-27 09:47:01
 * @FilePath: \mobile-miniprogram\src\common\components\uni-tooltip\index.vue
-->
<template>
	<view class="uni-tooltip" :class="{active: show}"  @click="toogleTooltip">
		<view>
			<slot></slot>
		</view>
