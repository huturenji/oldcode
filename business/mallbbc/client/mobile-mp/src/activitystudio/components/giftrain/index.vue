    ...
    <view class="giftrain">
        <view class="giftrain-content" v-show="showMask">
            ...
            <img
                ...
                :key="item.id"
                :class="['giftrain-content-rainimg', item.class]"
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                this.requestAnimationFrame && clearTimeout(this.requestAnimationFrame)
            },
            computedTime() {
            ...
            render() {
                ...
                this.requestAnimationFrame = setTimeout(this.render, 15)
            },
            addRainList() {
                // 红包和金币的数组，比例为 2:1
                let rainList = [
                    { img: 'https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_hongbao.png', width: 100, height: 100, rainType: 1 },
                    { img: 'https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_hongbao.png', width: 100, height: 100, rainType: 1 },
                    { img: 'https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_jinbi.png', width: 50, height: 50, rainType: 2 },
                ]
            ...
            touchStart(rainItem) {
                ...
                if (index !== -1) {
                    ...
                    if (rainItem.rainType === 1) {
                        ...
                        setTimeout(() => {
                            if (aniObj) {
                                this.$set(aniObj, 'class', 'pointSelect')
                                this.$set(aniObj, 'img', 'https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_xuanzhong.png')
                            }
...
.giftrain {
    ...
    .startRain {
        ...
        width: 500rpx;
        height: 120rpx;
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_anniu.png') no-repeat center;
    ...
    .startPointer {
        ...
        bottom: 34rpx;
        right: 140rpx;
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_shou.png') no-repeat center;
        background-size: 100% 100%;
...
.giftrain-content {
    ...
    .timeBefore {
        ...
        background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_circle.png') no-repeat center;
        background-size: 100% 100%;
        ...
        .timeBeforeNum {
            ...
            &.timeBeforeNum_3 {
                background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_3.png') no-repeat center;
                background-size: 100% 100%;
            }

            &.timeBeforeNum_2 {
                background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_2.png') no-repeat center;
                background-size: 100% 100%;
            }

            &.timeBeforeNum_1 {
                background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/giftrain/icon_cj_hby_1.png') no-repeat center;
                background-size: 100% 100%;
            }
        }
    }
    ...
    .giftrainSelect {
        animation: rainAni1 0.3s linear 0s 1;
    }

    .pointSelect {
        animation: rainAni2 0.4s linear 0s 1;
    }
}
