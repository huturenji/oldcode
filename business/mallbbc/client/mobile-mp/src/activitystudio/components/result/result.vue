<!--抽奖弹窗页-->
<template>
    <view :class="['container', ifGetPrize ? 'win_prize_bg' : 'not_win_prize_bg']">
    ...
    methods: {
        ...
        checkPrizeDetail() {
            if (this.ifGetPrize) {
                ...
                let url = ''
                if (this.ifPreview) {
                    url = `/activitystudio/detail/preview?activityId=${this.activityId}`
                    if (this.previewType) {
                        url += '&type=1'
                    }
                } else {
        ...
        .content {
            ...
            .get_btn {
                .searchBtn {
                    ...
                    color: #fff;
                    font-size: 30rpx;
                    background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/images/btn.png');
...
.win_prize_bg {
    background-image: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/images/bg_lql_zhongjiang.png");
}

.not_win_prize_bg {
    background-image: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/images/bg_lql_weizhongjiang.png");
}
</style>
