<template>
    <view class="squarenine">
        <view :class="'squarenine_box size_' + giftLength">
            ...
            <!-- 奖品列表 -->
            <view v-for="(item, i) in prizeList" :key="i" :class="[`gift gift_${i + 1}`]">
...
.squarenine {
    ...
    border-radius: 16rpx;
    background: url('https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/bg_cj_jgg_waikuang.png')no-repeat center;
    ...
    .squarenine_box {
        ...
        .activeBorder {
            ...
            top: 0;
            left: 0;
            background: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/icon_cj_jgg_sel.svg") no-repeat center;
            background-size: 100% 100%;
            z-index: 99;
        }
    }
    ...
    .squarenine_box.size_8 {
        ...
        .gift_1, .gift_3, .gift_5, .gift_7 {
            background: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/icon_cj_jgg_gezi1.png") no-repeat center;
        }
        
        .gift_2, .gift_4, .gift_6, .gift_8 {
            background: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/icon_cj_jgg_gezi2.png") no-repeat center;
        }
        ...
        .start {
            ...
            overflow: hidden;
            border-radius: 10rpx;
            background: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/icon_cj_jgg_bg.png") no-repeat center;
            background-size: 100% 100%;

            view {
                width: 100%;
                height: 100%;
                background: url("https://bbnjstaticba-sinosun.oss-cn-hangzhou.aliyuncs.com/Ba04ZWJgWx/miniProgram/activitystudio/squarenine/icon_cj_jgg_choujiang2.png") no-repeat center;
                background-size: 100% 100%;
