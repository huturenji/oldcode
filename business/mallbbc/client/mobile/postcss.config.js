...
module.exports = {
  ...
  plugins: [
    ...
    require('postcss-px-to-viewport')({
        ...
        viewportWidth: 10000,// 视窗的宽度，对应的是我们设计稿的宽度，转换比例为10000/viewportWidth
        ...
        viewportUnit: 'px', // 需要转成的单位，针对所有属性，默认vw
        ...
        exclude: process.env.UNI_PLATFORM.toLowerCase() !== 'h5' ? [/src/] : undefined,//(Array or Regexp) 设置忽略文件，如node_modules如果是regexp, 忽略全部匹配文件.如果是数组array, 忽略指定文件.  在非H5平台上忽略src下面的该功能
        include: undefined,
        landscape: false
    }),
