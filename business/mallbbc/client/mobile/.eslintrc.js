module.exports = {
    ...
    globals: {
        'sinosdk': true,//sdk全局变量
        'jWeixin': true,//weixinsdk
        'uni': true,//uniapp全局变量
        'ROUTES': true,
        'TIMESTAMP_ENV': true,
        'HOME_PAGE': true,
        'TAB_BARS': true,
        'SnUtils': true,//工具函数全局变量
        'getApp':true,
        'zc': true,//智齿科技全局变量
        'getCurrentPages': true,//uniapp中获取当前页面栈的实例，为全局方法
        'AMap': true,//高德地图
        'wx':true,//微信sdk
        'authorization':true,//授权对象
        'plus':true,//uniapp app内部对象
        'swpServiceAuth':true,//swp授权对象
        'trim':true,//trim对象
    ...
    rules: {
        ...
        "keyword-spacing":0,//该规则是控制关键字前后是否必须要有空格
        ...
        "vue/multi-word-component-names": [0, { "ignores": [] }],//vue组建名字必须用-分隔
        'vue/no-reserved-keys':0,//变量不能用_开头
        'vue/valid-template-root':0,//template不能为空
        'vue/no-mutating-props':0,//严格限制单项数据流
