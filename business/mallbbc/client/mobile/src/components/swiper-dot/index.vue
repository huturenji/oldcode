<template>
    <view class="custom_swiper_dot" :style="swiperDotStyle">
        <view v-if="mode === 'default'" :style="{background:background}" class="dot_container">
            <view v-for="index in dotNum" :key="index" :class="['default_dot', (index-1) === currentIndex ? 'default_dot_active' : '']" :style="{backgroundColor:(index-1) === currentIndex?activeDotColor:dotColor}"></view>
        </view>
