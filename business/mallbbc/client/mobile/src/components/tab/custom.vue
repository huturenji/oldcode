<template>
    <view class="tabs" :style="{ 'padding-bottom': isPC ? '10rpx' : 0 }" :class="{showScrollBar:isPC && showScrollBar}">
        <view class="tabs__wrapper">
            ...
            >
                ...
                >
                    ...
                    <!-- #ifdef APP-NVUE -->
                    <view
                        class="tabs__wrapper__nav__line"
                        ref="tabs__wrapper__nav__line"
                        :style="[{
                            width: addUnit(lineWidth),
                            height: addUnit(lineHeight),
                            backgroundColor: lineColor
                        }]"
                    ><slot name="slideBlock"></slot></view>
                    <!-- #endif -->
                    <!-- #ifndef APP-NVUE -->
                    <view
                        class="tabs__wrapper__nav__line"
...
<script>
import {isH5} from '@/utils/common.js'
export default {
    name: 'tabs-com',
    props: {
        // 滑块的移动过渡时间，单位ms
    ...
    methods: {
        ...
        /**
             ...
             * @param {object} targetpar 需要拷贝的对象
             * @param {object} source 拷贝的来源对象
             * @returns {object|boolean} 深度合并后的对象或者false（入参有不是对象）
             */
        deepMerge(targetpar = {}, source = {}) {
            let target = this.deepClone(targetpar)
