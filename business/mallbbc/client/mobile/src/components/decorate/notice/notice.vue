<template>
  <!--公告组件-->
  <view class="notice_box" v-margin="decoItem">
    <view
        ...
        return {
            noticeSetting: {
                one: {
                    ...
                    notice_img_url: getApp().globalData.imgUrl + "user/notice1.png",
                    notice_style_object: {
                        //滚动文字样式设置
                        speed: 1, //每秒30px
              ...
              "linear-gradient(to right,rgba(250,244,244,0.2) 0%, rgba(255,244,244,1) 50%, rgba(250,244,244,0.2) 100%);" //背景色
                ...
                two: {
                    ...
                    notice_img_url: getApp().globalData.imgUrl + "user/notice2.png",
                    notice_style_object: {
                        //滚动文字样式设置
                        speed: 1, //每秒30px
                        font_size: "24", //字体大小(rpx)
