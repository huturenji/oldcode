...
export default {
    ...
    methods:{
        ...
        getAllCouponList() {
            ...
            Promise.all([this.getCouponList(couponIdList),this.getFreightCouponList(freightCouponIdList),this.getConsumerCouponList(consumerCouponIdList),this.getRedPacketList(redPacketIdList)])
