...
export default {
    ...
    */
    getUnionGoodsList(param,url){
        return request({
            url: url || 'v3/goods/front/product/listRecommendSkus',
            method: 'POST',
            header:{"Content-Type": "application/json"},
            data: param
        })
    ...
    */
    ...
    /**
     * 批量领取优惠券
     * @param {*} param  优惠券id:卡密方式领取,不传;其他方式领取,必传
    */
    batchReceiveCoupon(param = {}){
        return request({
            url: 'v3/coupon/front/coupon/batchReceiveCoupon',
            data: param,
            method: 'POST',
            header:{"Content-Type": "application/json"}
        })
    ...
    */
    getStoreCouponList(param = {}){
        return request({
            url: 'v3/coupon/front/coupon/storeCouponList',
            data: param,
            method: 'POST',
            header:{"Content-Type": "application/json"}
        })
    ...
    */
    getSignActivityDetail(param = {}){
        return request({
            url: 'v3/marketing/front/sign/activity/detail',
            data: param
        })
    },
    ...
    */
    doSignOld(param = {}){
        return request({
            url: 'v3/marketing/front/sign/activity/doSign',
            data: param,
            method: 'POST'
        })
    },
    ...
    */
     ...
     * @param {*} param 
    */
    batchGetCouponDetail(param = {}){
        return request({
            url: 'v3/coupon/front/coupon/listDetail',
            data: param,
            method: 'POST',
            header:{"Content-Type": "application/json"}
        })
