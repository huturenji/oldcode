<template>
    <view class="container">
        ...
        <view class="wrapper">
            ...
            <button class="confirm-btn" @click="toLogin" :style="{opacity: (!(mobile&&smsCode)||logining)?0.5:1}">登录</button>
            <view class="login-register">
                <text class="mobile-login" @click="navTo('/pages/public/login',1)">{{$L('密码登陆')}}</text>
