...
export default {
    ...
    onPageScroll(e) {
        ...
        this.setTitleBarBackground(opacity)
    },
    mounted(){
        this.getUserPoints()
        this.getPointsList()
...
<style lang="scss">
    .container {
        ...
        overflow-x: hidden;
        background: url("@/static/shared/yundou/bg_dabeijing.png") left top/100% 486rpx no-repeat;
        .integral_top {
            margin-top: 200rpx;
            height: 238rpx;
            border-radius: 24rpx;
            ...
            .rules_entry {
                ...
                width: 132rpx;
                height: 44rpx;
                background: url("@/static/shared/yundou/bg_xq_yundouguize.png") center/100% 100% no-repeat;
            }
            .fudai {
                position: absolute;
                top: 70rpx;
                ...
                width: 224rpx;
                height: 160rpx;
                background: url("@/static/shared/yundou/fudai.png") center/100% 100% no-repeat;
            }
            ...
            .integral_item_wrap {
                ...
                .integral_item {
                    ...
                    .right {
                        ...
                        font-weight: normal;
                        color: #f30300;
                        background: url("@/static/shared/yundou/icon_douzi.png") left center/36rpx 36rpx no-repeat;
                        &.subtract_Integral {
                            color: #666666;
                        }
                    }
