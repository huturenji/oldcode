<template>
    <view v-if="!loading" class="container">
                    ...
                    <view class="right">
                        ...
                        <view v-if="shop.servicePhone && shop.servicePhone.length>0" class="phone">
                            ...
                            <view v-if="isPC" class="text">
                                <text v-for="(temp, index) in shop.servicePhone" :key="index">{{index==(shop.servicePhone.length-1) ? temp : (temp+',')}}</text>
                            </view>
                            <view v-else class="text">
                                <a v-for="(temp, index) in shop.servicePhone" :key="index" :href="'tel:'+ temp ">{{index==(shop.servicePhone.length-1) ? temp : (temp+',')}}</a>
                            </view>
                        </view>
                    </view>
                </view>
        ...
        <!-- 核销吸底按钮-->
        <view v-if="showCheckBtn" class="check_btn">
