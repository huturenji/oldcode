<template>
    <view class="container">
        ...
        <view class="input_part num-font">
        ...
        <u-button @click="getCashDetail" class="btn" :disabled="checkMark()" text="核销券码" color="#FF711E" shape="circle"></u-button>
    </view>
</template>
...
export default {
    ...
    methods: {
        checkMark(){
            return isEmpty(trimAllStr(this.code))
        },
        // 检测相关的参数为必填
        checkParams(){
