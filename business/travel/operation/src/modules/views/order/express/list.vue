<template>
    <div class="orderListPageExpress">
        <div class="headTitle">上门取件</div>
        <orderListPage
            orderType="Express"
            :tabList="tabList"
            :pageData="pageData"
                ...
                function(res) {
                    if (0 == res.resultCode) {
                        ...
                        let hotelOrders =
                            that.setOrderType(
                                data.hotelOrders,
                                utils.getBusinessType(3).typeCode,
                                utils.getBusinessType(3).typeName
                            ) || []; //酒店订单 注意Hotel首字母大写
                        let expressOrders =
                            that.setOrderType(
                                data.expressOrders,
