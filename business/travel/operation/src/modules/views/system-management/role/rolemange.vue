<template>
    <div class="rolemanges" id="rolemanges">
        <div v-if="checkAuth('seeRoleInfo')">
            <el-row v-if="checkAuth('addRole')">
                <el-col :span="24">
            ...
            <el-table
                ...
                >
                    <template slot-scope="scope">
                        <el-button v-if="checkAuth('seeRoleInfo')" type="text" @click="gotoUserDetail(scope.row.roleId)" >详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
export default {
    ...
    created() {
        let _this = this;
        if (_this.checkAuth("seeRoleInfo")
        ) {
            _this.hasAuth = true;
            _this.noAuth = false
            _this.getAllRole();
    ...
    methods: {
        ...
        getAllRole: function() {
            let _this = this;
            _this.$iLoading.show();
            tmHandler.listRole({ }).then(function(result) {
                _this.$iLoading.hide()
