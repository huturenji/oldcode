...
const trainconfirm = () => import("./trainconfirm.vue");
...
export default {
    ...
    computed: {
        ...
        bookBtnUnable: function () {
            ...
            try {
                result =
                    !!this.tuiOrder &&
                    utils.isTrainTicketREFUND_PROCESSING(
                        this.tuiOrder.orderStatus
                    );
            } catch (e) {
                result = null;
            }
    ...
    methods: {
        ...
        isChanging() {
            ...
            let falg = false;
            if (
                !this.ticket.isGaiOrder &&
                this.passenger.ticketStatus == "HAS_CHANGING"
            ) {
                utils.showToast("改签中");
                falg = true;
            }
