    ...
    <div>
        <div id="topnavWrap">
            <div class="topnav">
                <h4>{{ websitename }}</h4>
                <div class="resetPwd">
                    <span class="usenName" :title="welcomeuser">
                        {{ welcomeuser }}
                    </span>
                    <b
                        v-if="showUserIcon"
        ...
        >
            <div v-show="popTitle" slot="header" class="headerStyle">
                {{ popTitle }}
            </div>
            ...
            <div slot="footer" class="footerStyle">
                <Button class="btnStyle" type="primary" @click="logOut"
                    >确定</Button
                >
                <Button class="btnStyle" @click="closePopMain">取消</Button>
            </div>
        </Modal>
    </div>
</template>
