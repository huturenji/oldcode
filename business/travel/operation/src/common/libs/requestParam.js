...
class encryption{
     ...
     */
    initJWECrypt(config){
        this.JWECryptUtil = new JWECrypt(config.management);
    }
    ...
    async getBslParam(url, data, paramObj={}, bslConfig={}){
        ...
        let encryption = true;
        encryption = (false===paramObj.encryption || true===paramObj.encryption) ? paramObj.encryption : bslConfig.management.default_encryption_switch;
