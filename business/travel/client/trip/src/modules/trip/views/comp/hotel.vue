    ...
    <div class='list'>
        <div class="type">
            <div class="card-date card-date-hotel" :class="{flowId: trip.flowId}">
                ...
                <div v-if="isPC" @click="deleteOrder((hotel||{}).orderNo,hotel,trip,isHis)" class="delete_order">删除</div>
            </div>
        </div>
        <div class="full hotel card-shadow">
            <swipeout>
                <swipeout-item :disabled='isPC'>
                    ...
                    <div slot="content"  class="hotelDetail detailCard linear-gra-hotel cursorp" @click="openOrderDetail(hotel.orderNo)">
                        <div class="leave">
                            <div class="code">
...
export default {
    ...
    methods:{
        ...
        handleDate2Month(date) {
            return tripHandler.handleDate2Month(date);
        },
        ...
        handleTotalDay(hotel) {
            return tripHandler.handleTotalDay(new Date(hotel.beginDate).getTime(),new Date(hotel.arriveDate).getTime());
        },
        /**
             * 计算剩余时间
        ...
        remainTime(orderInfo){
            ...
            return tripHandler.countTime(todayTime, beginTime, endTime, 'hotel');
        },
        /**
             * 显示地图
             */
