...
const ZC_URL = 'https://bplus.soboten.com/chat/h5/v2/index.html?sysnum=dcce9016106c4275adca76544d320c18'; //客服对接应用的url
const ZC_SDK_URL = 'https://bplus.soboten.com/chat/frame/v2/entrance.js?sysnum=dcce9016106c4275adca76544d320c18'; //客服对接JS-SDK的js

class Customer {
    constructor(){
        this.settingConfig = {//系统的相关配置项，
            color:'262DD9', //聊天的主题颜色
            type:2 //仅人工客服模式
        }; 
