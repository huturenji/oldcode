    ...
    <div class="textBoxWrap">
        ...
        <div class="contentFlexWrap">
            <div class="contentWrap">
                <div class="textWrap">
                    <span class="left num-font" v-if='0!=hotel.commentScorer||".0"!=hotel.commentScorer'>{{hotel.commentScorer*10}}<span>%好评率</span></span>
...
export default {
    ...
    methods: {
        ...
        genLocation:function(locationPoint,hotel){
            let distance = extendUtils.getFlatternDistance(parseFloat(locationPoint.lat),parseFloat(locationPoint.lng),parseFloat(hotel.lat),parseFloat(hotel.lng));
            let temps = parseInt(distance);
            if (temps){
                if (temps<1000){
...
.iconWrap{
    ...
    span{
        ...
        width: 100%;
        height: 100%;
        background: rgba(0,0,0,0.5) url(~themes/default/img/hotel/icon_over.png) no-repeat center;
...
.titWrap{
    ...
    .star.starIcon4{
        ...
        background: url(~themes/default/img/hotel/icon_star4.png) no-repeat center;
    ...
    .star.starIcon5{
        ...
        margin-top: 0;
        vertical-align: text-bottom;
        background: url(~themes/default/img/hotel/icon_star5.png) no-repeat center;
        background-size: 95% 95%;
    }
}
.haveBack:after{
    ...
    width: 0.24rem;
    height: 0.24rem;
    background: url(~themes/default/img/hotel/icon_back.png) no-repeat center;
