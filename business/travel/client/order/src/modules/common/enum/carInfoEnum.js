...
export let carCpyData = {
    '0':{src: require('../../../assets/img/car/icon_logo_caocao.svg'), name: '曹操出行'},
    '2':{src: require('../../../assets/img/car/icon_logo_shenzhou.svg'), name: '神州专车'},
    '7':{src: require('../../../assets/img/car/icon_logo_caocao.svg'), name: '曹操出行'}
}
...
export let markerData = {
    ...
    'position':{src:'../assets/img/car/icon_map_positive.svg',sizeX:29,sizeY:29,positionX:-14,positionY:-29},
    'car':{src:'../assets/img/car/icon_taxi_car.svg',sizeX:29,sizeY:29,positionX:-14,positionY:-14},
    'startContent':{positionX:-12,positionY:-30},
    'endContent':{positionX:-12,positionY:-30},
    'carContent':{positionX:-12,positionY:-30}
}
/**
 * 常量
 */
