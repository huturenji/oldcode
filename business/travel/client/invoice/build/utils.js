...
exports.cssLoaders = function (options) {
    ...
    return {
        ...
        sass: generateLoaders('sass', Object.assign({ indentedSyntax: true },options.themeOptions.sass)),//todo 引入sass-resources-loader 定义全局sass与less变量  This loader is not limited to Sass resources. It supposedly works with less, post-css, etc
