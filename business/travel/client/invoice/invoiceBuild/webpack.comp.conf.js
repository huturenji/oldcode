...
module.exports = Object.assign(compWebpackConfig,{
    entry: NODE_ENV == 'development'?'./src/modules/payComp/src/demo/main.js':'./src/modules/invoiceManage/components/index.js',
    output: {
        path: path.resolve(__dirname, '../dist/swp-invoice'),
        publicPath: '../../swplib/bp/invoice/',
        filename: 'swp-invoice.js',
        library:'swp-invoice',//指定是required时的模块名
