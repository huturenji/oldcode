<template>
    <div class="insurancePopWrap">
        <div class="insurancePop">
            <div class="insuranceDetailWrap" v-if="haveOrderInfo">
                <template v-if="!!insuranceDetail.insuranceChildOrder">
                    ...
                    <div class="insuranceDetail">
                        ...
                        <div class="right">
                            <span>{{formatTime(insuranceDetail.airLineBriefInfo.departTime)+insuranceDetail.airLineBriefInfo.departCityName+'-'+insuranceDetail.airLineBriefInfo.arriveCityName}}</span>
                            <span class="logoTextWrap">
                                <br/>
            ...
            <div class="insuranceName"  v-if="!haveOrderInfo">{{insuranceDetail.productShortName}}</div>
            <div class="insuranceTit">保险费用</div>
            <div class="insuranceText">{{(insuranceDetail.insuranceProduct || insuranceDetail).farePrice}}元/份</div>
            <div class="insuranceTit">保险详情</div>
