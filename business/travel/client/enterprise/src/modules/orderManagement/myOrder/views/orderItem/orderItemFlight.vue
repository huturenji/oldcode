...
<script>
import { getFlightOrderStatus, getFlightOrderStatusColor, showFlightSubStatus, getFlightPostSaleStatus } from 'orderCommon/enum/orderStatusEnum.js'
...
export default {
    ...
    methods: {
         ...
         */
        goDetail() {
            this.$emit("goPage", "order/detail/flight/app?orderNo=" + this.orderItem.orderNo + "&pageFrom=orderList");
        },
        /**
        乘车人超出时添加点击效果
        */
