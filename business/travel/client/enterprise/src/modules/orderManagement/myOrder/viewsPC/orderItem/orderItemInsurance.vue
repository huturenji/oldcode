<template>
    <div class="order-item" v-if="fullScreen">
        <div class="order-summary">
            ...
            <label class="iconLabel">保险</label>
            ...
            <!-- <span class="showTitle"
                :tips="OrgNameFormatShow(orderItem.departmentName)"><span>部门：</span>{{orderItem.departmentName|OrgNameFormat}}</span> -->
        </div>
        <div class="order-detail">
            <div class="order-detail-block">
                <div><span>{{orderItem.productShortName}}</span></div>
                <div>
                    <div>
    ...
    <div class="pc-order-item" v-else>
        <div class="order-summary">
            ...
            <!-- <span v-if="showOrgnization"><span>部门：</span>{{orderItem.departmentName}}</span> -->
        </div>
        <div class="order-detail">
            <div class="order-detail-block">
                <div><span>{{orderItem.productShortName}}</span></div>
...
<script>
import { getInsuranceOrderStatus } from 'orderCommon/enum/orderStatusEnum.js';
...
export default {
    ...
    methods: {
        ...
        /**
             ...
             */
        goDetail() {                
            // this.$emit('goPage', "order/flightOrderDetail?OrderNo=" + this.orderItem.orderNo);
        }
    }
}
</script>
