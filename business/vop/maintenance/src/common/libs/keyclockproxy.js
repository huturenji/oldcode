...
class keyclockproxy {
    ...
    constructor() {
        ...
        this.clientId = 'MALLVOP_operation_front'
    }
    ...
    getLoginJsonConfig() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            let jsonFilePath = process.env.NODE_ENV == 'production' ? `../keycloak.json` : '../thirdparty/keycloak/keycloak.json'
        ...
        return new Promise(function (resolve, reject) {
            that.getLoginJsonConfig().then(option => {
                vue.use(VueKeyCloak, {
                    ...
                    //无论任何页面，发生登录退出，都推到首页
                    logout: {
                        redirectUri: window.origin + "/mallvop/static/maintenance/index.html"
                    },
