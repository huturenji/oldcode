<template>
    <div>
        <div
            v-bind:class="[
                type == 'img' ? 'demo-upload-list' : 'demo-upload-list2',
            ]"
...
const pdfBaseUrl =
    window.origin +
    "/mallvop/static/operation/thirdparty/pdfjs/web/viewer.html?file=";
const mediaFileUpUrl =
    window.origin + "/mall" + "/file/v1/upload?c=static&p=/mallvop/file&n=";
const mediaFileViewUrl = window.origin + "/mall" + "/file/v1/content/static/p";
export default {
