...
export default {
            ...
            moduleList: [
                {
                    ...
                    tabs: [
                        ...
                        },
                        {
                            ...
                            dataDesc: "name：配置name，status：配置状态"
                        }
                    ]
                },
                {
                    ...
                    tabs: [
                        ...
                        },
                        {
                            ...
                            dataDesc:
                                "skuId：商品编号，remainNum：库存数量，stockStateDesc：库存状态描述，\nstockStateId：库存状态:\n33有货现货-下单立即发货\n36 预订\n34 无货\n"
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    tabs: [
                        ...
                        },
                        {
                            ...
                            dataDesc:
                                "skuId：商品id，ecPrice：西域价格，price：价格"
                        }
                    ]
                }
                // {
                ...
                //             },
                //             dataDesc:
                //                 "sku：商品id，cityCode：西域二级地址编号，areaRestrict：是否限制,true是限制,false是不限制",
                //         },
                //     ],
                // },
            ],
    ...
    mounted() {
        virtualHandler.setBaseUrlSY(this.envValue);
        this.moduleValue = 1;
    },
    watch: {
        envValue(newVal) {
            virtualHandler.setBaseUrlSY(newVal);
