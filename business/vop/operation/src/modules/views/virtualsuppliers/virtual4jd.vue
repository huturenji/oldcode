...
export default {
    data() {
        return {
            moduleList: [
                ...
                },
                {
                    ...
                    tabs: [
                        ...
                        },
                        {
                            ...
                            dataDesc:
                                "skuId：商品编号，areaId：格式31_2714_2720_15879，分别是省市区镇，镇为空写0，remainNum：库存数量，stockStateDesc：库存状态描述，\nstockStateId：库存状态:\n33有货现货-下单立即发货\n39 有货 在途-正在内部配货，预计2~6天到达本仓库\n40 有货 可配货-下单后从有货仓库配货\n36 预订\n34 无货\n99 无货开预定，此时desc返回的数值代表预计到货天数"
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    tabs: [
                        ...
                        },
                        {
                            ...
                            dataDesc:
                                "skuId：商品id，jdPrice：京东价格，price：价格"
                        }
                    ]
                }
                // {
                ...
                //             },
                //             dataDesc:
                //                 "sku：商品id，areaId：区域id，areaRestrict：是否限制,true是限制,false是不限制",
                //         },
                //     ],
                // },
            ],
    ...
    mounted() {
        virtualHandler.setBaseUrl(this.envValue);
        this.moduleValue = 1;
    },
    watch: {
        envValue(newVal) {
            virtualHandler.setBaseUrl(newVal);
