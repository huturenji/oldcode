                            ...
                            >
                                <template slot-scope="scope">
                                    <el-checkbox-group v-model="scope.row.checkData">
                                        ...
                                        >{{ auth.permissionName }}</el-checkbox>
                                    </el-checkbox-group>
                                </template>
                            </el-table-column>
                        </el-table>
...
export default {
    ...
    methods: {
        ...
        getAllPermission: function(selectedAuthData) {
            let _this = this;
            _this.$iLoading.show();
            systemhandler.listPermission({}).then(function(
                result
            ) {
                _this.$iLoading.hide();
        ...
        getRoleDetail: function() {
            ...
            _this.$iLoading.show();
            systemhandler.getRoleDetail(json).then(function(result) {
                _this.$iLoading.hide();
                if (!!result && result.resultCode == 0) {
        ...
        editRole: function() {
            ...
            systemhandler.updateRole(json).then(function(
                result
            ) {
