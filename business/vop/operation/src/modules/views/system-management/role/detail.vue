        ...
        <div v-if="!isLoading">
            <div class="btnbos">
                ...
                <el-button 
                    ...
                    plain 
                    @click="delrole=!!1" 
                    v-if="hasTheAuth('delRole')"
                >删除</el-button>
                <el-button
                    type="primary"
                    @click="gotoEdit"
                    v-if="hasTheAuth('editRole')"
                >
                    编辑
                </el-button>
            </div>
...
export default {
    ...
    methods: {
        ...
        deleteRole: function() {
            ...
            _this.$iLoading.show();
            systemhandler.deleteRole(json).then(
                function(result) {
                    _this.$iLoading.hide();
        ...
        getRoleDetail: function() {
            ...
            _this.$iLoading.show();
            systemhandler.getRoleDetail(json).then(function(
                result
            ) {
                _this.$iLoading.hide();
                if (!!result && result.resultCode == 0) {
