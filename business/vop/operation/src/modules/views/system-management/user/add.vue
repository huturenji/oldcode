                ...
                <el-col :span="24">
                    ...
                    >
                        ...
                        >
                            <template slot-scope="scope">
                                <el-button
                                    @click="deleteuser(scope.$index,scope.row.userId)"
                                    type="text"
                                >
                                    删除
                                </el-button>
                ...
                <div class="seclctuser">
                    <div class="left">
                        ...
                        <div class="check padding">
                            ...
                            <div class="alluser">
                                ...
                                <p v-if="!loading && emptyRes && sotals!==0">
                                    没有更多了
                                </p>
                                <p v-if="!loading && sotals==0">
                                    暂无数据
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="right ">
                        ...
                        <ul class="check padding">
                            <li
                                v-for="(user,index) in seletcPerson"
                                :key="index"
                            >
...
export default {
    ...
    methods: {
        ...
        searchCompanyUsers() {
            ...
            systemhandler.searchCompanyUser(params).then(
                res => {
                    if (res.resultCode == 0) {
                        ...
                        this.tempDate = utils.removedDuplicate(
                            this.tempDate,
                            "userId"
                        );
        ...
        // 获取所有角色
        getAllRole() {
            systemhandler.listRole().then(res => {
                if (res.resultCode == 0) {
        ...
        checckPerson(val) {
            let arr = [];
            arr = utils.getArrEqual(this.noChecked, val); //checkbox的vm值 == 已选择人员  和未添加的几个取交集   就是新添加的人员
            //所有人员集合去重
            let temp = [];
            temp = utils.filterCommonData(this.tempDate, arr); //新添加人员   和所有人对比   取到name  account信息
        ...
        adduserInfo() {
            ...
            if (this.tableData.length > 0) {
                ...
                systemhandler.addUser(params).then(res => {
