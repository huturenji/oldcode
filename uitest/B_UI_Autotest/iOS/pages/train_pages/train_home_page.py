...
class TrainHomePage(BasePage):
    ...
    #     # 选择日期元素
    #     page_blank_loc = (int(self.width() * 0.5), int(self.height() * 0.62))
    #     # 点击日期
    #     self.touch_tap(page_blank_loc)
    ...
    def selection_day(self, day):
        ...
        # 选择日期元素
        date = (By.XPATH,
                "//li[contains(@class, 'isToday')]/../..//following::div[@class='cursorp'][{}]".format(day))
        # 点击选择的日期
        self.click_element(self.wait_element_clickable(date, "出发日期"))

    @allure.step("点击查询按钮, 跳转至新的编辑订单标签页")
