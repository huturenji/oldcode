...
class OrderDetailsPage(BasePage):
    ...
    def click_payment_button(self):
        """点击去支付按钮"""
        return self.click_element(self.wait_precence_element(self.payment_button_loc, "支付按钮"))
    ...
    @allure.step("返回订单详情页面：获取订单'已支付'状体")
    def pay_result_text(self):
        return self.wait_element_visible(self.result_text_loc, "订单已支付状态字段").text
