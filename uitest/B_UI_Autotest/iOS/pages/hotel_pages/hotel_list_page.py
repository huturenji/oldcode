...
class HotelListPage(BasePage):
    ...
    # 页面顶部的'搜索'框
    search_input_loc = (By.XPATH, "//input[@placeholder='酒店/位置/品牌']")
    ...
    @allure.step("酒店列表页：点击价格/星级筛选按钮")
    def click_price_star_search_btn(self):
        self.js_click(self.wait_element_clickable(self.price_star_search_loc, "价格/星级筛选按钮"))
