...
class TestTrainOrder:
    ...
    @allure.issue("https://www.cnblogs.com/zdx20/", "点击查看禅道Bug……")
    @allure.testcase("http://tools.android-studio.org/index.php/sdk", "点击查看禅道用例……")
    ...
    def test_train_order_smoke(self, driver):
        ...
        # 选择车次
        train_number_list_page.wait_data_load(False, 1)
        ...
        with assume: assert result == "付款成功", "付款不成功，或者没有出现结果页面"
        # 点击“查看详情”按钮
